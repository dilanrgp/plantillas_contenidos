			...
			<div class="config-container">
				<div class="template-config">
					...
					<fieldset id="CONFIG_TEMPLATE_4" class="config-content">
						...
						<div class="img-preview" <?php if( strlen($img_path) > 1) : ?> style="background-image:url(<?php echo $img_path?>)" <?php endif;?> >
						...
						<img src="templates/logo_colegiala.gif" class="producto_logo">					
