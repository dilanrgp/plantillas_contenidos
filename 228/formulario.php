...
if(isset($config)){
	...
	$priced = isset($json_data->diesel) ? $json_data->diesel : '';
	$priceg = isset($json_data->diesel) ? $json_data->gasolina : '';
} else {
	$descripcion = 'Marca 1';
				...
				<div class="template-config">
	 				<div class="fields-ofertas">
						<div class="field-price">
							<textarea name="SUBPRICE" id="SUBPRICE" placeholder="Llévate 2 por"><?= $subprice ?></textarea>
							<input type="text" name="PRICE" id="PRICE" placeholder="1,50€" value="<?= $price ?>">
						</div>
						<div class="info">
							<textarea name="DESCRIPCION" id="DESCRIPCION" placeholder="Marca 1"><?= $descripcion ?></textarea>
							<textarea name="SUBDESCRIPCION" id="SUBDESCRIPCION" placeholder="Descripción 1"><?= $subdescripcion ?></textarea>
						</div>
						<div class="info info-2" id="INFO_2">
							<textarea name="DESCRIPCION_2" id="DESCRIPCION_2" placeholder="Marca 2"><?= $descripcion_2 ?></textarea>
							<textarea name="SUBDESCRIPCION_2" id="SUBDESCRIPCION_2" placeholder="Descripción 2"><?= $subdescripcion_2 ?></textarea>
						</div>
						<input type="text" name="LEGAL" id="LEGAL" placeholder="Oferta válida hasta el 31 de mayo de 2030" value="<?= $legal ?>">
					</div>
