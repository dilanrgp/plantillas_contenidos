 ...
 */
	...
	$directoriocliente = $directoriobase."/".$idcustomer."_2/";
	$dirbase = "ids.ladorianids.es";
	$plantillascontenido = "/plantillascontenidov4/".$idcustomer."_2/";
...
<body class="<?php echo $bg_clases; ?>">
	<div class="wrapper" id="TEMPLATE_CONTENT">
		<div class="contenedor" name = "divcuerpoHTML" id="divcuerpoHTML">
			<img src="templates/cruz.png" class="icon">
			<header>
				<?php if( $data['farmacia'] ) : ?>
					<div class="nombre">
						<h2>
							<span id="FARMA">Farmacia</span>
							<span id="NOMBRE_FARMACIA"><?php echo $data['farmacia']; ?></span>
						</h2>
					</div>
				<?php endif; ?>
			...
			<?php else : ?>
				...
				<section class="oferta__main">
					<figure class="oferta__img">
						<div style="background-image:url(<?php echo $imagen; ?>)" class="img"></div>
					</figure>
	...
	<script >
			function grabarplantilla()
			{
				...
				var contenedor =
								...
								"<link rel='stylesheet' href='<?php echo $directoriocliente?>"+"farma.css'>"+
								"<?php if( $has_bg_img ) { 
