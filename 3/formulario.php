...
<head>
	<meta charset="UTF-8">
	<title>Formulario de creacion de promocion para CECOP</title>

	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/css/bootstrap.min.css">

	<link rel="stylesheet" href="css/cecop-template.css">
</head>
<?php   
...
<div class="row">
			...
			<div class="row align-items-center">
				<div class="form-check col">
					<label for="TEMPLATE-2" class="template-selection">
						...
						<div class="cell">
							<p>Oferta</p>
							<img src="cecop/templates/oferta_2.jpg">
						</div>
					</label>
				</div>
			</div>
		...
		<fieldset class="col-md-12 form-group" id="CONFIG">
			...
			<div class="config-container">
				<div class="template-config">
					...
					<input type="text" name="LEGAL" id="LEGAL" placeholder="Promoción válida hasta el 31 de mayo">
	...
	<script src="js/cecop.js?tmp=<?=time()?>"></script>
