			...
			function grabarplantilla()
			{
				...
				var contenedor =
								 ...
								 "<body class='<?php echo $bg_clases; ?>'>"+
								 	"<div class='<?= $template_number != 5 ? 'wrapper' : '' ?>' id='TEMPLATE_CONTENT' >"+ document.getElementById("TEMPLATE_CONTENT").innerHTML + "</div>"+
                                 "</body>"+
                                 "</html>";
...
<body class="<?php echo $bg_clases; ?>">
	<div class="<?= $template_number !== '5' ? 'wrapper' : '' ?>" id="TEMPLATE_CONTENT">
		<div class="contenedor">
			...
			<?php elseif( $template_number !== '3' && $template_number !== '5' ) : ?>
