...
<div class="row">
	<form action="preview.php" method="POST" id="TEMPLATE_FORM" enctype="multipart/form-data">
			...
			<div class="row align-items-center">
				...
				<div class="form-check col">
					<label for="TEMPLATE-5" class="template-selection">
						...
						<div class="cell">
							<p>Precios</p>
							<img src="img/templates/precios.jpg">
						</div>
					</label>
				</div>
			</div>
		...
		<fieldset class="form-group col precios" id="CONFIG_2">
			<h3>Define los precios</h3>
			<div class="config-container">
				<div class="template-config">
					<input type="text" name="PRICE_DIESEL" id="PRICE_DIESEL" value="<?= $priced ?>" class="price" placeholder="1,999" required>
					<input type="text" name="PRICE_GASOLINA" id="PRICE_GASOLINA" value="<?= $priceg ?>" class="price" placeholder="1,999" required>
				</div>
			</div>
		</fieldset>
