...
function onsubmitform()
{
  ...
  if(eleccion[0].checked)
	url= pathName+"7/formulario.php";
  if(eleccion[1].checked)
	url= pathName+"20/formulario.php";
  if(eleccion[2].checked)
	url= pathName+"40/formulario.php";	
  if(eleccion[3].checked)	 
	url= pathName+"26/formulario.php";
  if(eleccion[4].checked)	 
	url= pathName+"61/formulario.php";
  if(eleccion[5].checked)	 
	url= pathName+"91/formulario.php";
...
if($entorno == 'demo'){	
	...
	while ($obj = $result->fetch_object()){
		...
		<label for='TEMPLATE-".$cont."' class='template-selection'>
			...
			<div class='cell'>						
				<input type='radio' id='".$obj->name."' name='TEMPLATE' id='TEMPLATE-".$cont."' value='TEMPLATE-".$cont."' ".$checked.">
